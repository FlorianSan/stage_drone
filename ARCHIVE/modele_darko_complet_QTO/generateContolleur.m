...
controlleur = struct('kap',5.0, ... %gain proportionnel erreur d'orientation
                     'kad',5.0, ... %gain dérivatif erreur d'orientation
                     'kpp',2.0, ...  %gain proportionnel erreur de position
