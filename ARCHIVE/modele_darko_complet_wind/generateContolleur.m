...
kappa = norm(drone.Fb*[1;0;1;0]);
u_barre = [1;0;1;0]/kappa; %on observe que u_barre = -0.7139 * v1 donc u_barre appartient au ker(M)
...
controlleur = struct('kap',1.0, ... %gain proportionnel erreur d'orientation
                     'kad',1.0, ... %gain dérivatif erreur d'orientation
                     'kpp',4.0, ...  %gain proportionnel erreur de position
                     'kpd',4.0, ... %gain dérivatif erreur de vitesse
