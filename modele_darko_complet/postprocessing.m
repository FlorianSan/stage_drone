...
[ha, pos] = tight_subplot(4,1,.03,.05,.1);
axes(ha(1)); 
plot(out.tout, out.positions(:,1),'b', 'LineWidth', 2)
hold on
plot(out.tout, out.positions(:,2), 'r', 'LineWidth', 2)
plot(out.tout, out.positions(:,3), 'g', 'LineWidth', 2)
...
grid on
ylabel('[m]')
legend('p_{x}','p_{y}','p_{z}','Orientation','horizontal','Location','south')
set(gca,'Xticklabel',[])
%xlabel('time [s]')

axes(ha(2));
plot(out.tout, out.orientation_deg(:,1), 'LineWidth', 2)
hold on
plot(out.tout, out.orientation_deg(:,2), 'LineWidth', 2)
plot(out.tout, out.orientation_deg(:,3), 'LineWidth', 2)
grid on
ylabel('[deg]')
ylim([-20 140])
...
axes(ha(3));
plot(out.tout, out.commande(:,1), 'LineWidth', 2)
hold on
plot(out.tout, -out.commande(:,2), 'LineWidth', 2)
grid on
ylabel('[rpm]')
...
axes(ha(4));
plot(out.tout, out.commande(:,3), 'LineWidth', 2)
hold on
plot(out.tout, out.commande(:,4), 'LineWidth', 2)
grid on
ylabel('[deg]')
ylim([-35 35])
