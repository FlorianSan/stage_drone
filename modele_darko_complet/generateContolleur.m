...
controlleur = struct('kap',0.08, ... %gain proportionnel erreur d'orientation
                     'kad',0.1, ... %gain dérivatif erreur d'orientation
                     'kpp',0.5, ...  %gain proportionnel erreur de position
                     'kpd',1.2, ... %gain dérivatif erreur de vitesse
